...
urlpatterns = [
    ...
    path('users/<int:user_id>/details/', views.user_details_api, name='user_details_api'),
    path('users/<int:user_id>/update/', views.user_update_api, name='user_update_api'),
    path('users/<int:user_id>/toggle-status/', views.user_toggle_status_api, name='user_toggle_status_api'),
    path('users/<int:user_id>/delete/', views.user_delete_api, name='user_delete_api'),
